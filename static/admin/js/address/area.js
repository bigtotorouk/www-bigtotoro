...
var s=["id_province","id_city","id_area"];//三个select的name
var opt0 = ["省份","地级市","市、县级市"];//初始值
function _init_area(){  //初始化函数
	var provinceSelect = document.getElementById(s[0]);
	var citySelect = document.getElementById(s[0]);
	var areaSelect = document.getElementById(s[0]);
	var province = provinceSelect.options[index].value;
	var city = citySelect.options[index].value;
	var area = areaSelect.options[index].value;

	for(i=0;i<s.length-1;i++){
		document.getElementById(s[i]).options.length = 0; //清空select
	...
	//if(province){
	//	document.getElementById(s[0]).val(province);
	//	if(city){
	//		document.getElementById(s[1]).val(city);
	//		if(area){
	//			document.getElementById(s[2]).val(area);
	//		}
	//	}
	//}
}

//function _init_area(province, city, area){
//	_init_area();
//	if(province){
//		document.getElementById(s[0]).val(province);
//		if(city){
